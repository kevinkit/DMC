...
//----<WELCHES DAVON IST RICHTIG/ WAS IST DER UNTERSCHIED ? GIBT ES DADURCH EINEN UNTERSCHIED ??!>
...
void main()
{
	...
	while(1)	{
		...
		// A/D-Converter Kanalauswahl
			...
			if(!ADCON0bits.CHS2 && !ADCON0bits.CHS1 && !ADCON0bits.CHS0)	{		//Stupid..... 1&&1&&1 = 1 Oh, WOW!!!
				// Berechnung von x
				x = ADRES >> 6;
