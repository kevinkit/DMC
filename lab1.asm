...
SWAPF ADRESH, 1,0 ;nibbles tauschen KANN MIT SWAPF DIREKT INS WREG GESCHRIEBEN WERDEN?! ALSO MOVF VORHER RAUSNEHMEN!
MOVFF WREG, PORTA ;; werte an die LED schicken
...
wait_for_ad
    BTFSS ADCON0, 2 ;chekcen ob auf 0
BRA wait_for_ad
...
BTG PORTC, 2
;;könnte auch als subroutine verwendet werden
inverter
